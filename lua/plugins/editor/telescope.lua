local function setup()
	...
	vim.keymap.set("n", "<leader>js", tele.buffers, { desc = "Telescope buffers" })
	...
	-- vim.keymap.set("n", "<C-j>", tele.lsp_references, { desc = "Telescope LSP references" })
	vim.keymap.set("n", "<leader>rs", tele.lsp_references, { desc = "Telescope LSP references" })
