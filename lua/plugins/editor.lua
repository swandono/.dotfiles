...
local G = {
	...
	config = function()
		...
		vim.keymap.set("n", "<D-j>", function()
			harpoon:list():select(1)
		end, { desc = "Harpoon nav file 1 (MacOS)" })
		vim.keymap.set("n", "<D-k>", function()
			harpoon:list():select(2)
		end, { desc = "Harpoon nav file 2 (MacOS)" })
		vim.keymap.set("n", "<D-l>", function()
			harpoon:list():select(3)
		end, { desc = "Harpoon nav file 3 (MacOS)" })
		vim.keymap.set("n", "<D-u>", function()
			harpoon:list():select(4)
		end, { desc = "Harpoon nav file 4 (MacOS)" })
		vim.keymap.set("n", "<D-i>", function()
			harpoon:list():select(5)
		end, { desc = "Harpoon nav file 5 (MacOS)" })
		vim.keymap.set("n", "<D-o>", function()
			harpoon:list():select(6)
		end, { desc = "Harpoon nav file 6 (MacOS)" })
