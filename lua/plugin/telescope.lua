return {
    ...
    config = function()
        ...
        vim.keymap.set("n", "<leader>m1", function() harp_ui.nav_file(1) end)
        vim.keymap.set("n", "<leader>m2", function() harp_ui.nav_file(2) end)
        vim.keymap.set("n", "<leader>m3", function() harp_ui.nav_file(3) end)
        vim.keymap.set("n", "<leader>m4", function() harp_ui.nav_file(4) end)
        vim.keymap.set("n", "<leader>m5", function() harp_ui.nav_file(5) end)
